...
- [2019.09.15](#20190915)
  ...
  - [2. **直方图均衡**](#2-直方图均衡)
  - [3. **Guide Achoring**](#3-Guide-Achoring)
  - [4. **反向传播 & softmaxloss & 矩阵求导**](#4-反向传播--softmaxloss--矩阵求导)
  - [5. **mAP 的理解**](#5-mAP-的理解)
  - [6. **Batch Norm**](#6-Batch-Norm)
  - [7. **梯度下降算法VS拟牛顿法**](#7-梯度下降算法VS拟牛顿法)
  - [8. **解决创建环境时conda版本不匹配问题**](#8-解决创建环境时conda版本不匹配问题)
...
![](http://latex.codecogs.com/gif.latex?\sum_{i=0}^{n}a_{i}^{2}&plus;b_{i}^{2})
